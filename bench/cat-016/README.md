...
> [!NOTE]
> This rule targets **compile-time performance** (compiler speed, binary size), not runtime. The benchmark measures AST parsing overhead, not execution speed. Useful for large codebases but low priority for small projects.
